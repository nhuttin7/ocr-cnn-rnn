...
"""=========================================================================="""
# Convert text to image contains text
...
def paint_text(text, w, h, rotate=False, ud=False, multi_fonts=False):
    ...
    blur = ndimage.gaussian_filter(np.random.randn(*a.shape) * np.random.uniform(0, 0.6), 1)
    a = (a + blur)
    a[a > 1] = 1
    a[a <= 0] = 0
    return a
...
"""==========================================================================""" 
# CTC loss calcutation for sequencing data
